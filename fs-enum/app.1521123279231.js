(function () {
    ...
    if (isIE()) {
        alert('不支持IE浏览器，请使用chrome, firefox, safari或者360极速模式等');
        return;
    }
                    ...
                    React.createElement("div", {
                        ...
                        React.createElement("div", null,
                            React.createElement("ul", {
                                ...
                                React.createElement("li", null, React.createElement("a", {
                                    href: "http://tieba.baidu.com/home/main?un=zhuhuitonfg",
                                    target: "_blank"
                                }, "贴吧ID：拖泥猪"))
                            )
                        )
    ...
    var InputRow = React.createClass({
        ...
        handleClick: function () {
            ...
            EventEmitter.dispatch('btnClick', {
                _num: _num,
                _res1: _res1,
                _res2: _res2
            });
            this.refs.num1.setState({
                num: ''
            });
            this.refs.num2.setState({
                num: ''
            });
            this.refs.num3.setState({
                num: ''
            });
        ...
        render: function () {
            return (
                React.createElement("div", {
                    ...
                    React.createElement(InputBtn, {
                        title: "确定",
                        cls: "form-control btn btn-success",
                        handleClick: this.handleClick
                    }),
                    React.createElement(InputBtn, {
                        title: "重置",
                        cls: "form-control btn btn-primary",
            ...
            EventEmitter.subscribe('btnClick', function (data) {
                ...
                $this.setState({
                    ...
                    record: $this.state.record.concat([
                        [data._num, data._res1, data._res2, _list.length]
                    ])
                });
            });
                    ...
                    React.createElement("div", {
                        ...
                        React.createElement("div", {
                            ...
                            React.createElement("div", {
                                ...
                                "枚举结果", React.createElement("span", {
                                    style: {
                                        marginLeft: "10px"
                                    }
                                }, this.state.item), "项", React.createElement("span", {
                                    style: {
                                        marginLeft: "10px"
                                    }
                                }, "当前第", React.createElement("span", null, this.state.round), "轮")
                            ),
                            React.createElement("div", {
                    ...
                    React.createElement("div", {
                        ...
                        React.createElement("div", {
                            ...
                            React.createElement("div", {
                                ...
                                React.createElement("div", null, "打赏赞助，感谢支持~", React.createElement("span", {
